...
function MapAvatar({ person, isPlayer, isNearby, isVideo, isSpeaking, isInCall, onClick, reaction }) {
  ...
  return (
    <g onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
      ...
      {isInCall && <g><circle cx={px - r * 0.7} cy={py + r * 0.5} r={5} fill="rgba(0,0,0,0.85)" stroke={T.accent} strokeWidth={1} /><text x={px - r * 0.7} y={py + r * 0.5 + 3} textAnchor="middle" fontSize={6} fill={T.accent}>🎧</text></g>}
